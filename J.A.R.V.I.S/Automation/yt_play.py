...
def perform_media_action(text):
    if "volume up" in text or "volume badhao" in text:
        ...
        volume_down()
    elif "sick forward" in text or "aage badhao" in text:
        seek_forward()
    elif "sckk backward" in text or "peeche karo" in text:
        seek_backward()
    elif "sick forward 10 seconds" in text or "10 second aage badhao" in text:
        seek_forward_10s()
    elif "sick backward 10 seconds" in text or "10 second peeche karo" in text:
        seek_backward_10s()
    elif "sick backward frame" in text or "frame peeche karo" in text:
        seek_backward_frame()
    elif "sick forward frame" in text or "frame aage badhao" in text:
        seek_forward_frame()
    elif "sick to beginning" in text or "shuruat par jao" in text:
        seek_to_beginning()
    elif "sick to end" in text or "ant par jao" in text:
        seek_to_end()
    elif "sick to previous chapter" in text or "previous chapter par jao" in text:
        seek_to_previous_chapter()
    elif "sick to next chapter" in text or "next chapter par jao" in text:
